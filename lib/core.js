...
var Core = (function () {
    ...
    Core.prototype.init = function (appGlobal, userApp) {
        ...
        this.pathAndObjectMerge(this.pathAndObjectList, this.getModulesPath(global.app_modules("**/module-go.json"), global.Modules, global.Config));
     ...
     * @returns {Array}
     */
    Core.prototype.getModulesPath = function (pathRoot, pathObject, configObject) {
        var _this = this;
        ...
        files.forEach(function (file) {
            ...
            if (modulePath = _this.pathGetIfExist(path.normalize(path.dirname(file) + '/src/')))
                filesList[modulePath] = pathObject[moduleName] = {};
            // Override module path for src "config" dir
            if (modulePath = _this.pathGetIfExist(path.normalize(path.dirname(file) + '/config/')))
     ...
     * @returns {any}
     */
    Core.prototype.pathGetIfExist = function (pathString) {
        try {
