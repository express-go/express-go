 ...
 * Framework helpers
 */
export function base_path (innerPath?: string) : string;
export function npm_path (innerPath?: string)  : string;
export function bower_path (innerPath?: string)  : string;

/**
 * Storage helpers
 */
export function storage_path (innerPath?: string, getRelative?: boolean)  : string;
export function cache_path (innerPath?: string, getRelative?: boolean)  : string;
export function logs_path (innerPath?: string, getRelative?: boolean)  : string;
